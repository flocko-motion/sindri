...
import (
	...
	"github.com/flo-at/sindri/internal/version"
)
...
func (m *Model) ensureUpdatePreviewModal() {
	...
	case version.InstallMethodBinary:
		downloadURL := fmt.Sprintf("https://github.com/flo-at/sindri/releases/tag/%s",
...
func (m *Model) ensureUpdateErrorModal() {
	...
	case version.InstallMethodGo:
		...
		manualFix = "go install github.com/flo-at/sindri/cmd/sidecar@latest"
	default:
		methodName = "binary"
		manualFix = "github.com/flo-at/sindri/releases"
	}
	...
	reportHint := styles.Muted.Render("Report: github.com/flo-at/sindri/issues")
