...
import (
	...
	"github.com/flo-at/sindri/internal/community"
	"github.com/flo-at/sindri/internal/config"
	"github.com/flo-at/sindri/internal/mouse"
	"github.com/flo-at/sindri/internal/palette"
...
func (m *Model) handleKeyMsg(msg tea.KeyMsg) (tea.Model, tea.Cmd) {
	...
	case "I":
		// Shift-I: jump to td tab and create a new issue
		if m.consumesTextInput() {
			break
		}
		cmd := m.SetActivePlugin(0)
		// Forward "n" to the td plugin to open its create form
	...
	case "^":
		...
		return m, nil
	// "i" is reserved for plugin-level input mode (workspace)
	// Use shift-I for global new issue creation
	case "r":
