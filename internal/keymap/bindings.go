...
func DefaultBindings() []Binding {
	return []Binding{
		...
		{Key: "I", Command: "new-issue", Context: "global"},
		...
		{Key: "ctrl+h", Command: "switch-pane", Context: "git-status"},
		{Key: "ctrl+l", Command: "switch-pane", Context: "git-status"},
		...
		{Key: "ctrl+h", Command: "switch-pane", Context: "conversations-sidebar"},
		{Key: "ctrl+l", Command: "switch-pane", Context: "conversations-sidebar"},
		...
		{Key: "ctrl+h", Command: "switch-pane", Context: "conversations-main"},
		{Key: "ctrl+l", Command: "switch-pane", Context: "conversations-main"},
		...
		{Key: "ctrl+h", Command: "switch-pane", Context: "file-browser-tree"},
		{Key: "ctrl+l", Command: "switch-pane", Context: "file-browser-tree"},
		...
		{Key: "ctrl+h", Command: "switch-pane", Context: "file-browser-preview"},
		{Key: "ctrl+l", Command: "switch-pane", Context: "file-browser-preview"},
		...
		{Key: "ctrl+l", Command: "focus-right", Context: "workspace-list"},
		{Key: "ctrl+h", Command: "switch-pane", Context: "workspace-list"},
		{Key: "ctrl+l", Command: "switch-pane", Context: "workspace-list"},
		...
		{Key: "ctrl+h", Command: "focus-left", Context: "workspace-preview"},
		...
		{Key: "ctrl+h", Command: "switch-pane", Context: "workspace-preview"},
		{Key: "ctrl+l", Command: "switch-pane", Context: "workspace-preview"},
		...
		{Key: "ctrl+h", Command: "switch-pane", Context: "notes-editor"},
