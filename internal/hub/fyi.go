...
const (
	// maxNoteLen is the longest note accepted. Over-length is REFUSED, never truncated: a silent cut
	// drops the point and teaches nothing, so the next note is exactly as long.
	maxNoteLen = 300
