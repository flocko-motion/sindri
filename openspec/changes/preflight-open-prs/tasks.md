...
- [x] 6.4 Mutation-checked compilably: defeating the memo fails the debounce test, and pointing the
      rebase at the author's tree fails the untouched-tree test.
